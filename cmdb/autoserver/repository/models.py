...
class BusinessUnit(models.Model):
    ...
    contact = models.ForeignKey('UserGroup', verbose_name='业务联系人', related_name='c',on_delete=models.DO_NOTHING)
    manager = models.ForeignKey('UserGroup', verbose_name='系统管理员', related_name='m',on_delete=models.DO_NOTHING)
...
class Asset(models.Model):
    ...
    business_unit = models.ForeignKey('BusinessUnit', verbose_name='属于的业务线', null=True, blank=True,on_delete=models.SET_NULL)
...
class Disk(models.Model):
    ...
    server_obj = models.ForeignKey('Server',related_name='disk',on_delete=models.DO_NOTHING)
...
class NIC(models.Model):
    ...
    server_obj = models.ForeignKey('Server',related_name='nic',on_delete=models.DO_NOTHING)
...
class Memory(models.Model):
    ...
    server_obj = models.ForeignKey('Server',related_name='memory',on_delete=models.DO_NOTHING)
