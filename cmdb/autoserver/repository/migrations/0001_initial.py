# Generated by Django 2.2.5 on 2019-09-11 02:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('server_obj', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='nic', to='repository.Server')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('server_obj', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='memory', to='repository.Server')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('server_obj', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='disk', to='repository.Server')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='c', to='repository.UserGroup', verbose_name='业务联系人')),
                ('manager', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='m', to='repository.UserGroup', verbose_name='系统管理员')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='repository.UserProfile')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='asset',
            name='business_unit',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='repository.BusinessUnit', verbose_name='属于的业务线'),
        ),
        migrations.AddField(
            model_name='asset',
            name='idc',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='repository.IDC', verbose_name='IDC机房'),
        ),
        migrations.AddField(
            model_name='asset',
            name='tag',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_info', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='repository.UserProfile')),
            ],
            options={
